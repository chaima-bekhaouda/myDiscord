...
root = Tk()
root.title("Login")
root.geometry("925x500+300+200")  # Garder les mêmes dimensions
...
def signin():
    ...
    if username in r.keys() and password == r[username]:
        ...
        welcome_screen.geometry("925x500+300+200")  # Garder les mêmes dimensions
...
def signup_command():
    ...
    signup_window.geometry("925x500+300+200")  # Garder les mêmes dimensions
    ...
    def signup():
        ...
        if password == conform_password:
            try:
                ...
                w = file.write(str(r))
                messagebox.showinfo("Success", f"Account created successfully. {w} characters written to the file.")
